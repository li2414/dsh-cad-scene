...
`)}var s0={[Pl]:"Linear",[Il]:"Reinhard",[Ll]:"Cineon",[Dl]:"ACESFilmic",[Ul]:"AgX",[Fl]:"Neutral",[Nl]:"Custom"};function r0(i,e){let t=s0[e];return t===void 0?(Oe("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var Io=new U;function a0(){Qe.getLuminanceCoefficients(Io);let i=Io.x.toFixed(4),e=Io.y.toFixed(4),t=Io.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+f);let R=C+p+o,y=C+f+a,E=iu(s,s.VERTEX_SHADER,R),v=iu(s,s.FRAGMENT_SHADER,y);s.attachShader(S,E),s.attachShader(S,v),t.index0AttributeName!==void 0?s.bindAttribLocation(S,0,t.index0AttributeName):t.hasPositionAttribute===!0&&s.bindAttribLocation(S,0,"position"),s.linkProgram(S);function M(I){if(i.debug.checkShaderErrors){let B=s.getProgramInfoLog(S)||"",G=s.getShaderInfoLog(E)||"",D=s.getShaderInfoLog(v)||"",X=B.trim(),$=G.trim(),j=D.trim(),ne=!0,F=!0;if(s.getProgramParameter(S,s.LINK_STATUS)===!1)if(ne=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,S,E,v);else{let W=ru(s,E,"vertex"),J=ru(s,v,"fragment");ke("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(S,s.VALIDATE_STATUS)+`
...
}`,k0=[new U(1,0,0),new U(-1,0,0),new U(0,1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1)],z0=[new U(0,-1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1),new U(0,-1,0),new U(0,-1,0)],fu=new at,hr=new U,ic=new U;function V0(i,e,t){let n=new ji,s=new Le,r=new Le,o=new bt,a=new wa,c=new Ta,l={},u=t.maxTextureSize,d={[ri]:Xt,[Xt]:ri,[an]:an},h=new tn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Le},radius:{value:4}},vertexShader:O0,fragmentShader:B0}),m=h.clone();m.defines.HORIZONTAL_PASS=1;let _=new Bt;_.setAttribute("position",new Yt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let S=new Lt(_,h),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=er;let f=this.type;this.render=function(v,M,x){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||v.length===0)return;this.type===oh&&(Oe("WebGLShadowMap: PCFSoftShadowMap has been removed. Using PCFShadowMap instead."),this.type=er);let w=i.getRenderTarget(),A=i.getActiveCubeFace(),I=i.getActiveMipmapLevel(),B=i.state;B.setBlending(wn),B.buffers.depth.getReversed()===!0?B.buffers.color.setClear(0,0,0,0):B.buffers.color.setClear(1,1,1,1),B.buffers.depth.setTest(!0),B.setScissorTest(!1);let G=f!==this.type;G&&M.traverse(function(D){D.material&&(Array.isArray(D.material)?D.material.forEach(X=>X.needsUpdate=!0):D.material.needsUpdate=!0)});for(let D=0,X=v.length;D<X;D++){let $=v[D],j=$.shadow;if(j===void 0){Oe("WebGLShadowMap:",$,"has no shadow.");continue}if(j.autoUpdate===!1&&j.needsUpdate===!1)continue;s.copy(j.mapSize);let ne=j.getFrameExtents();s.multiply(ne),r.copy(j.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/ne.x),s.x=r.x*ne.x,j.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/ne.y),s.y=r.y*ne.y,j.mapSize.y=r.y));let F=i.state.buffers.depth.getReversed();if(j.camera._reversedDepth=F,j.map===null||G===!0){if(j.map!==null&&(j.map.depthTexture!==null&&(j.map.depthTexture.dispose(),j.map.depthTexture=null),j.map.dispose()),this.type===ss){if($.isPointLight){Oe("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}j.map=new qt(s.x,s.y,{format:ci,type:xn,minFilter:Dt,magFilter:Dt,generateMipmaps:!1}),j.map.texture.name=$.name+".shadowMap",j.map.depthTexture=new jn(s.x,s.y,on),j.map.depthTexture.name=$.name+".shadowMapDepth",j.map.depthTexture.format=Mn,j.map.depthTexture.compareFunction=null,j.map.depthTexture.minFilter=Pt,j.map.depthTexture.magFilter=Pt}else $.isPointLight?(j.map=new Do(s.x),j.map.depthTexture=new Ma(s.x,_n)):(j.map=new qt(s.x,s.y),j.map.depthTexture=new jn(s.x,s.y,_n)),j.map.depthTexture.name=$.name+".shadowMap",j.map.depthTexture.format=Mn,this.type===er?(j.map.depthTexture.compareFunction=F?Ro:Co,j.map.depthTexture.minFilter=Dt,j.map.depthTexture.magFilter=Dt):(j.map.depthTexture.compareFunction=null,j.map.depthTexture.minFilter=Pt,j.map.depthTexture.magFilter=Pt);j.camera.updateProjectionMatrix()}j.map.isWebGLCubeRenderTarget!==!0&&(j.map.width!==s.x||j.map.height!==s.y)&&j.map.setSize(s.x,s.y);let W=j.map.isWebGLCubeRenderTarget?6:j.getViewportCount();$.isPointLight!==!0&&j.updateMatrices($,x);for(let J=0;J<W;J++){let oe=j.getCamera(J);if($.isPointLight){let re=j.camera,le=j.matrix,Fe=$.distance||re.far;Fe!==re.far&&(re.far=Fe,re.updateProjectionMatrix()),hr.setFromMatrixPosition($.matrixWorld),re.position.copy(hr),ic.copy(re.position),ic.add(k0[J]),re.up.copy(z0[J]),re.lookAt(ic),re.updateMatrixWorld(),le.makeTranslation(-hr.x,-hr.y,-hr.z),fu.multiplyMatrices(re.projectionMatrix,re.matrixWorldInverse),j._frustum.setFromProjectionMatrix(fu,re.coordinateSystem,re.reversedDepth)}if(j.map.isWebGLCubeRenderTarget)i.setRenderTarget(j.map,J),i.clear();else{J===0&&(i.setRenderTarget(j.map),i.clear());let re=j.getViewport(J);o.set(r.x*re.x,r.y*re.y,r.x*re.z,r.y*re.w),B.viewport(o)}n=j.getFrustum(J),y(M,x,oe,$,this.type)}j.isPointLightShadow!==!0&&this.type===ss&&C(j,x),j.needsUpdate=!1}f=this.type,p.needsUpdate=!1,i.setRenderTarget(w,A,I)};function C(v,M){let x=e.update(S);h.defines.VSM_SAMPLES!==v.blurSamples&&(h.defines.VSM_SAMPLES=v.blurSamples,m.defines.VSM_SAMPLES=v.blurSamples,h.needsUpdate=!0,m.needsUpdate=!0),v.mapPass===null?v.mapPass=new qt(s.x,s.y,{format:ci,type:xn}):(v.mapPass.width!==v.map.width||v.mapPass.height!==v.map.height)&&v.mapPass.setSize(v.map.width,v.map.height),h.uniforms.shadow_pass.value=v.map.depthTexture,h.uniforms.resolution.value.set(v.map.width,v.map.height),h.uniforms.radius.value=v.radius,i.setRenderTarget(v.mapPass),i.clear(),i.renderBufferDirect(M,null,x,h,S,null),m.uniforms.shadow_pass.value=v.mapPass.texture,m.uniforms.resolution.value.set(v.map.width,v.map.height),m.uniforms.radius.value=v.radius,i.setRenderTarget(v.map),i.clear(),i.renderBufferDirect(M,null,x,m,S,null)}function R(v,M,x,w){let A=null,I=x.isPointLight===!0?v.customDistanceMaterial:v.customDepthMaterial;if(I!==void 0)A=I;else if(A=x.isPointLight===!0?c:a,i.localClippingEnabled&&M.clipShadows===!0&&Array.isArray(M.clippingPlanes)&&M.clippingPlanes.length!==0||M.displacementMap&&M.displacementScale!==0||M.alphaMap&&M.alphaTest>0||M.map&&M.alphaTest>0||M.alphaToCoverage===!0){let B=A.uuid,G=M.uuid,D=l[B];D===void 0&&(D={},l[B]=D);let X=D[G];X===void 0&&(X=A.clone(),D[G]=X,M.addEventListener("dispose",E)),A=X}if(A.visible=M.visible,A.wireframe=M.wireframe,w===ss?A.side=M.shadowSide!==null?M.shadowSide:M.side:A.side=M.shadowSide!==null?M.shadowSide:d[M.side],A.alphaMap=M.alphaMap,A.alphaTest=M.alphaToCoverage===!0?.5:M.alphaTest,A.map=M.map,A.clipShadows=M.clipShadows,A.clippingPlanes=M.clippingPlanes,A.clipIntersection=M.clipIntersection,A.displacementMap=M.displacementMap,A.displacementScale=M.displacementScale,A.displacementBias=M.displacementBias,A.wireframeLinewidth=M.wireframeLinewidth,A.linewidth=M.linewidth,x.isPointLight===!0&&A.isMeshDistanceMaterial===!0){let B=i.properties.get(A);B.light=x}return A}function y(v,M,x,w,A){if(v.visible===!1)return;if(v.layers.test(M.layers)&&(v.isMesh||v.isLine||v.isPoints)&&(v.castShadow||v.receiveShadow&&A===ss)&&(!v.frustumCulled||v.intersectsFrustum(n))){v.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,v.matrixWorld);let G=e.update(v),D=v.material;if(Array.isArray(D)){let X=G.groups;for(let $=0,j=X.length;$<j;$++){let ne=X[$],F=D[ne.materialIndex];if(F&&F.visible){let W=R(v,F,w,A);v.onBeforeShadow(i,v,M,x,G,W,ne),i.renderBufferDirect(x,null,G,W,v,ne),v.onAfterShadow(i,v,M,x,G,W,ne)}}}else if(D.visible){let X=R(v,D,w,A);v.onBeforeShadow(i,v,M,x,G,X,null),i.renderBufferDirect(x,null,G,X,v,null),v.onAfterShadow(i,v,M,x,G,X,null)}}let B=v.children;for(let G=0,D=B.length;G<D;G++)y(B[G],M,x,w,A)}function E(v){v.target.removeEventListener("dispose",E);for(let x in l){let w=l[x],A=v.target.uuid;A in w&&(w[A].dispose(),delete w[A])}}}function H0(i,e){function t(){let N=!1,me=new bt,ee=null,ge=new bt(0,0,0,0);return{setMask:function(ve){ee!==ve&&!N&&(i.colorMask(ve,ve,ve,ve),ee=ve)},setLocked:function(ve){N=ve},setClear:function(ve,se,Ie,Ce,gt){gt===!0&&(ve*=Ce,se*=Ce,Ie*=Ce),me.set(ve,se,Ie,Ce),ge.equals(me)===!1&&(i.clearColor(ve,se,Ie,Ce),ge.copy(me))},reset:function(){N=!1,ee=null,ge.set(-1,0,0,0)}}}function n(){let N=!1,me=!1,ee=null,ge=null,ve=null;return{setReversed:function(se){if(me!==se){let Ie=e.get("EXT_clip_control");se?Ie.clipControlEXT(Ie.LOWER_LEFT_EXT,Ie.ZERO_TO_ONE_EXT):Ie.clipControlEXT(Ie.LOWER_LEFT_EXT,Ie.NEGATIVE_ONE_TO_ONE_EXT),me=se;let Ce=ve;ve=null,this.setClear(Ce)}},getReversed:function(){return me},setTest:function(se){se?Y(i.DEPTH_TEST):ie(i.DEPTH_TEST)},setMask:function(se){ee!==se&&!N&&(i.depthMask(se),ee=se)},setFunc:function(se){if(me&&(se=Vh[se]),ge!==se){switch(se){case aa:i.depthFunc(i.NEVER);break;case oa:i.depthFunc(i.ALWAYS);break;case la:i.depthFunc(i.LESS);break;case Wi:i.depthFunc(i.LEQUAL);break;case ca:i.depthFunc(i.EQUAL);break;case ha:i.depthFunc(i.GEQUAL);break;case ua:i.depthFunc(i.GREATER);break;case da:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}ge=se}},setLocked:function(se){N=se},setClear:function(se){ve!==se&&(ve=se,me&&(se=1-se),i.clearDepth(se))},reset:function(){N=!1,ee=null,ge=null,ve=null,me=!1}}}function s(){let N=!1,me=null,ee=null,ge=null,ve=null,se=null,Ie=null,Ce=null,gt=null;return{setTest:function(lt){N||(lt?Y(i.STENCIL_TEST):ie(i.STENCIL_TEST))},setMask:function(lt){me!==lt&&!N&&(i.stencilMask(lt),me=lt)},setFunc:function(lt,cn,yn){(ee!==lt||ge!==cn||ve!==yn)&&(i.stencilFunc(lt,cn,yn),ee=lt,ge=cn,ve=yn)},setOp:function(lt,cn,yn){(se!==lt||Ie!==cn||Ce!==yn)&&(i.stencilOp(lt,cn,yn),se=lt,Ie=cn,Ce=yn)},setLocked:function(lt){N=lt},setClear:function(lt){gt!==lt&&(i.clearStencil(lt),gt=lt)},reset:function(){N=!1,me=null,ee=null,ge=null,ve=null,se=null,Ie=null,Ce=null,gt=null}}}let r=new t,o=new n,a=new s,c=new WeakMap,l=new WeakMap,u={},d={},h={},m=new WeakMap,_=[],S=null,p=!1,f=null,C=null,R=null,y=null,E=null,v=null,M=null,x=new Ve(0,0,0),w=0,A=!1,I=null,B=null,G=null,D=null,X=null,$=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS),j=!1,ne=0,F=i.getParameter(i.VERSION);F.indexOf("WebGL")!==-1?(ne=parseFloat(/^WebGL (\d)/.exec(F)[1]),j=ne>=1):F.indexOf("OpenGL ES")!==-1&&(ne=parseFloat(/^OpenGL ES (\d)/.exec(F)[1]),j=ne>=2);let W=null,J={},oe=i.getParameter(i.SCISSOR_BOX),re=i.getParameter(i.VIEWPORT),le=new bt().fromArray(oe),Fe=new bt().fromArray(re);function Ne(N,me,ee,ge){let ve=new Uint8Array(4),se=i.createTexture();i.bindTexture(N,se),i.texParameteri(N,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(N,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ie=0;Ie<ee;Ie++)N===i.TEXTURE_3D||N===i.TEXTURE_2D_ARRAY?i.texImage3D(me,0,i.RGBA,1,1,ge,0,i.RGBA,i.UNSIGNED_BYTE,ve):i.texImage2D(me+Ie,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ve);return se}let q={};q[i.TEXTURE_2D]=Ne(i.TEXTURE_2D,i.TEXTURE_2D,1),q[i.TEXTURE_CUBE_MAP]=Ne(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),q[i.TEXTURE_2D_ARRAY]=Ne(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),q[i.TEXTURE_3D]=Ne(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),Y(i.DEPTH_TEST),o.setFunc(Wi),Me(!1),Ge(Ml),Y(i.CULL_FACE),fe(wn);function Y(N){u[N]!==!0&&(i.enable(N),u[N]=!0)}function ie(N){u[N]!==!1&&(i.disable(N),u[N]=!1)}function Re(N,me){return h[N]!==me?(i.bindFramebuffer(N,me),h[N]=me,N===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=me),N===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=me),!0):!1}function ce(N,me){let ee=_,ge=!1;if(N){ee=m.get(me),ee===void 0&&(ee=[],m.set(me,ee));let ve=N.textures;if(ee.length!==ve.length||ee[0]!==i.COLOR_ATTACHMENT0){for(let se=0,Ie=ve.length;se<Ie;se++)ee[se]=i.COLOR_ATTACHMENT0+se;ee.length=ve.length,ge=!0}}else ee[0]!==i.BACK&&(ee[0]=i.BACK,ge=!0);ge&&i.drawBuffers(ee)}function Ue(N){return S!==N?(i.useProgram(N),S=N,!0):!1}let rt={[_i]:i.FUNC_ADD,[ch]:i.FUNC_SUBTRACT,[hh]:i.FUNC_REVERSE_SUBTRACT};rt[uh]=i.MIN,rt[dh]=i.MAX;let Ye={[fh]:i.ZERO,[ph]:i.ONE,[mh]:i.SRC_COLOR,[Al]:i.SRC_ALPHA,[bh]:i.SRC_ALPHA_SATURATE,[yh]:i.DST_COLOR,[_h]:i.DST_ALPHA,[gh]:i.ONE_MINUS_SRC_COLOR,[Cl]:i.ONE_MINUS_SRC_ALPHA,[vh]:i.ONE_MINUS_DST_COLOR,[xh]:i.ONE_MINUS_DST_ALPHA,[Sh]:i.CONSTANT_COLOR,[Mh]:i.ONE_MINUS_CONSTANT_COLOR,[Eh]:i.CONSTANT_ALPHA,[wh]:i.ONE_MINUS_CONSTANT_ALPHA};function fe(N,me,ee,ge,ve,se,Ie,Ce,gt,lt){if(N===wn){p===!0&&(ie(i.BLEND),p=!1);return}if(p===!1&&(Y(i.BLEND),p=!0),N!==lh){if(N!==f||lt!==A){if((C!==_i||E!==_i)&&(i.blendEquation(i.FUNC_ADD),C=_i,E=_i),lt)switch(N){case rs:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case El:i.blendFunc(i.ONE,i.ONE);break;case wl:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Tl:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:ke("WebGLState: Invalid blending: ",N);break}else switch(N){case rs:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case El:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case wl:ke("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Tl:ke("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:ke("WebGLState: Invalid blending: ",N);break}R=null,y=null,v=null,M=null,x.set(0,0,0),w=0,f=N,A=lt}return}ve=ve||me,se=se||ee,Ie=Ie||ge,(me!==C||ve!==E)&&(i.blendEquationSeparate(rt[me],rt[ve]),C=me,E=ve),(ee!==R||ge!==y||se!==v||Ie!==M)&&(i.blendFuncSeparate(Ye[ee],Ye[ge],Ye[se],Ye[Ie]),R=ee,y=ge,v=se,M=Ie),(Ce.equals(x)===!1||gt!==w)&&(i.blendColor(Ce.r,Ce.g,Ce.b,gt),x.copy(Ce),w=gt),f=N,A=!1}function Be(N,me){N.side===an?ie(i.CULL_FACE):Y(i.CULL_FACE);let ee=N.side===Xt;me&&(ee=!ee),Me(ee),N.blending===rs&&N.transparent===!1?fe(wn):fe(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),o.setFunc(N.depthFunc),o.setTest(N.depthTest),o.setMask(N.depthWrite),r.setMask(N.colorWrite);let ge=N.stencilWrite;a.setTest(ge),ge&&(a.setMask(N.stencilWriteMask),a.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),a.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),mt(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?Y(i.SAMPLE_ALPHA_TO_COVERAGE):ie(i.SAMPLE_ALPHA_TO_COVERAGE)}function Me(N){I!==N&&(N?i.frontFace(i.CW):i.frontFace(i.CCW),I=N)}function Ge(N){N!==rh?(Y(i.CULL_FACE),N!==B&&(N===Ml?i.cullFace(i.BACK):N===ah?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):ie(i.CULL_FACE),B=N}function We(N){N!==G&&(j&&i.lineWidth(N),G=N)}function mt(N,me,ee){N?(Y(i.POLYGON_OFFSET_FILL),(D!==me||X!==ee)&&(D=me,X=ee,o.getReversed()&&(me=-me),i.polygonOffset(me,ee))):ie(i.POLYGON_OFFSET_FILL)}function Je(N){N?Y(i.SCISSOR_TEST):ie(i.SCISSOR_TEST)}function $e(N){N===void 0&&(N=i.TEXTURE0+$-1),W!==N&&(i.activeTexture(N),W=N)}function P(N,me,ee){ee===void 0&&(W===null?ee=i.TEXTURE0+$-1:ee=W);let ge=J[ee];ge===void 0&&(ge={type:void 0,texture:void 0},J[ee]=ge),(ge.type!==N||ge.texture!==me)&&(W!==ee&&(i.activeTexture(ee),W=ee),i.bindTexture(N,me||q[N]),ge.type=N,ge.texture=me)}function vt(){let N=J[W];N!==void 0&&N.type!==void 0&&(i.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function nt(){try{i.compressedTexImage2D(...arguments)}catch(N){ke("WebGLState:",N)}}function T(){try{i.compressedTexImage3D(...arguments)}catch(N){ke("WebGLState:",N)}}function g(){try{i.texSubImage2D(...arguments)}catch(N){ke("WebGLState:",N)}}function O(){try{i.texSubImage3D(...arguments)}catch(N){ke("WebGLState:",N)}}function z(){try{i.compressedTexSubImage2D(...arguments)}catch(N){ke("WebGLState:",N)}}function K(){try{i.compressedTexSubImage3D(...arguments)}catch(N){ke("WebGLState:",N)}}function ae(){try{i.texStorage2D(...arguments)}catch(N){ke("WebGLState:",N)}}function he(){try{i.texStorage3D(...arguments)}catch(N){ke("WebGLState:",N)}}function Q(){try{i.texImage2D(...arguments)}catch(N){ke("WebGLState:",N)}}function te(){try{i.texImage3D(...arguments)}catch(N){ke("WebGLState:",N)}}function ue(N){return d[N]!==void 0?d[N]:i.getParameter(N)}function Te(N,me){d[N]!==me&&(i.pixelStorei(N,me),d[N]=me)}function pe(N){le.equals(N)===!1&&(i.scissor(N.x,N.y,N.z,N.w),le.copy(N))}function de(N){Fe.equals(N)===!1&&(i.viewport(N.x,N.y,N.z,N.w),Fe.copy(N))}function Ae(N,me){let ee=l.get(me);ee===void 0&&(ee=new WeakMap,l.set(me,ee));let ge=ee.get(N);ge===void 0&&(ge=i.getUniformBlockIndex(me,N.name),ee.set(N,ge))}function De(N,me){let ge=l.get(me).get(N);c.get(me)!==ge&&(i.uniformBlockBinding(me,ge,N.__bindingPointIndex),c.set(me,ge))}function Xe(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),o.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),u={},d={},W=null,J={},h={},m=new WeakMap,_=[],S=null,p=!1,f=null,C=null,R=null,y=null,E=null,v=null,M=null,x=new Ve(0,0,0),w=0,A=!1,I=null,B=null,G=null,D=null,X=null,le.set(0,0,i.canvas.width,i.canvas.height),Fe.set(0,0,i.canvas.width,i.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:Y,disable:ie,bindFramebuffer:Re,drawBuffers:ce,useProgram:Ue,setBlending:fe,setMaterial:Be,setFlipSided:Me,setCullFace:Ge,setLineWidth:We,setPolygonOffset:mt,setScissorTest:Je,activeTexture:$e,bindTexture:P,unbindTexture:vt,compressedTexImage2D:nt,compressedTexImage3D:T,texImage2D:Q,texImage3D:te,pixelStorei:Te,getParameter:ue,updateUBOMapping:Ae,uniformBlockBinding:De,texStorage2D:ae,texStorage3D:he,texSubImage2D:g,texSubImage3D:O,compressedTexSubImage2D:z,compressedTexSubImage3D:K,scissor:pe,viewport:de,reset:Xe}}function G0(i,e,t,n,s,r,o){let a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Le,u=new WeakMap,d=new Set,h,m=new WeakMap,_=!1;try{_=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function S(T,g){return _?new OffscreenCanvas(T,g):Rs("canvas")}function p(T,g,O){let z=1,K=nt(T);if((K.width>O||K.height>O)&&(z=O/Math.max(K.width,K.height)),z<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){let ae=Math.floor(z*K.width),he=Math.floor(z*K.height);h===void 0&&(h=S(ae,he));let Q=g?S(ae,he):h;return Q.width=ae,Q.height=he,Q.getContext("2d").drawImage(T,0,0,ae,he),Oe("WebGLRenderer: Texture has been resized from ("+K.width+"x"+K.height+") to ("+ae+"x"+he+")."),Q}else return"data"in T&&Oe("WebGLRenderer: Image in DataTexture is too big ("+K.width+"x"+K.height+")."),T;return T}function f(T){return T.generateMipmaps}function C(T){i.generateMipmap(T)}function R(T){return T.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?i.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function y(T,g,O,z,K,ae=!1){if(T!==null){if(i[T]!==void 0)return i[T];Oe("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let he;z&&(he=e.get("EXT_texture_norm16"),he||Oe("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let Q=g;if(g===i.RED&&(O===i.FLOAT&&(Q=i.R32F),O===i.HALF_FLOAT&&(Q=i.R16F),O===i.UNSIGNED_BYTE&&(Q=i.R8),O===i.UNSIGNED_SHORT&&he&&(Q=he.R16_EXT),O===i.SHORT&&he&&(Q=he.R16_SNORM_EXT)),g===i.RED_INTEGER&&(O===i.UNSIGNED_BYTE&&(Q=i.R8UI),O===i.UNSIGNED_SHORT&&(Q=i.R16UI),O===i.UNSIGNED_INT&&(Q=i.R32UI),O===i.BYTE&&(Q=i.R8I),O===i.SHORT&&(Q=i.R16I),O===i.INT&&(Q=i.R32I)),g===i.RG&&(O===i.FLOAT&&(Q=i.RG32F),O===i.HALF_FLOAT&&(Q=i.RG16F),O===i.UNSIGNED_BYTE&&(Q=i.RG8),O===i.UNSIGNED_SHORT&&he&&(Q=he.RG16_EXT),O===i.SHORT&&he&&(Q=he.RG16_SNORM_EXT)),g===i.RG_INTEGER&&(O===i.UNSIGNED_BYTE&&(Q=i.RG8UI),O===i.UNSIGNED_SHORT&&(Q=i.RG16UI),O===i.UNSIGNED_INT&&(Q=i.RG32UI),O===i.BYTE&&(Q=i.RG8I),O===i.SHORT&&(Q=i.RG16I),O===i.INT&&(Q=i.RG32I)),g===i.RGB_INTEGER&&(O===i.UNSIGNED_BYTE&&(Q=i.RGB8UI),O===i.UNSIGNED_SHORT&&(Q=i.RGB16UI),O===i.UNSIGNED_INT&&(Q=i.RGB32UI),O===i.BYTE&&(Q=i.RGB8I),O===i.SHORT&&(Q=i.RGB16I),O===i.INT&&(Q=i.RGB32I)),g===i.RGBA_INTEGER&&(O===i.UNSIGNED_BYTE&&(Q=i.RGBA8UI),O===i.UNSIGNED_SHORT&&(Q=i.RGBA16UI),O===i.UNSIGNED_INT&&(Q=i.RGBA32UI),O===i.BYTE&&(Q=i.RGBA8I),O===i.SHORT&&(Q=i.RGBA16I),O===i.INT&&(Q=i.RGBA32I)),g===i.RGB&&(O===i.UNSIGNED_SHORT&&he&&(Q=he.RGB16_EXT),O===i.SHORT&&he&&(Q=he.RGB16_SNORM_EXT),O===i.UNSIGNED_INT_5_9_9_9_REV&&(Q=i.RGB9_E5),O===i.UNSIGNED_INT_10F_11F_11F_REV&&(Q=i.R11F_G11F_B10F)),g===i.RGBA){let te=ae?Cs:Qe.getTransfer(K);O===i.FLOAT&&(Q=i.RGBA32F),O===i.HALF_FLOAT&&(Q=i.RGBA16F),O===i.UNSIGNED_BYTE&&(Q=te===ht?i.SRGB8_ALPHA8:i.RGBA8),O===i.UNSIGNED_SHORT&&he&&(Q=he.RGBA16_EXT),O===i.SHORT&&he&&(Q=he.RGBA16_SNORM_EXT),O===i.UNSIGNED_SHORT_4_4_4_4&&(Q=i.RGBA4),O===i.UNSIGNED_SHORT_5_5_5_1&&(Q=i.RGB5_A1)}return(Q===i.R16F||Q===i.R32F||Q===i.RG16F||Q===i.RG32F||Q===i.RGBA16F||Q===i.RGBA32F)&&e.get("EXT_color_buffer_float"),Q}function E(T,g){let O;return T?g===null||g===_n||g===os?O=i.DEPTH24_STENCIL8:g===on?O=i.DEPTH32F_STENCIL8:g===as&&(O=i.DEPTH24_STENCIL8,Oe("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===_n||g===os?O=i.DEPTH_COMPONENT24:g===on?O=i.DEPTH_COMPONENT32F:g===as&&(O=i.DEPTH_COMPONENT16),O}function v(T,g){return f(T)===!0||T.isFramebufferTexture&&T.minFilter!==Pt&&T.minFilter!==Dt?Math.log2(Math.max(g.width,g.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?g.mipmaps.length:1}function M(T){let g=T.target;g.removeEventListener("dispose",M),w(g),g.isVideoTexture&&u.delete(g),g.isHTMLTexture&&d.delete(g)}function x(T){let g=T.target;g.removeEventListener("dispose",x),I(g)}function w(T){let g=n.get(T);if(g.__webglInit===void 0)return;let O=T.source,z=m.get(O);if(z){let K=z[g.__cacheKey];K.usedTimes--,K.usedTimes===0&&A(T),Object.keys(z).length===0&&m.delete(O)}n.remove(T)}function A(T){let g=n.get(T);i.deleteTexture(g.__webglTexture);let O=T.source,z=m.get(O);delete z[g.__cacheKey],o.memory.textures--}function I(T){let g=n.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),n.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let z=0;z<6;z++){if(Array.isArray(g.__webglFramebuffer[z]))for(let K=0;K<g.__webglFramebuffer[z].length;K++)i.deleteFramebuffer(g.__webglFramebuffer[z][K]);else i.deleteFramebuffer(g.__webglFramebuffer[z]);g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer[z])}else{if(Array.isArray(g.__webglFramebuffer))for(let z=0;z<g.__webglFramebuffer.length;z++)i.deleteFramebuffer(g.__webglFramebuffer[z]);else i.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&i.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let z=0;z<g.__webglColorRenderbuffer.length;z++)g.__webglColorRenderbuffer[z]&&i.deleteRenderbuffer(g.__webglColorRenderbuffer[z]);g.__webglDepthRenderbuffer&&i.deleteRenderbuffer(g.__webglDepthRenderbuffer)}let O=T.textures;for(let z=0,K=O.length;z<K;z++){let ae=n.get(O[z]);ae.__webglTexture&&(i.deleteTexture(ae.__webglTexture),o.memory.textures--),n.remove(O[z])}n.remove(T)}let B=0;function G(){B=0}function D(){return B}function X(T){B=T}function $(){let T=B;return T>=s.maxTextures&&Oe("WebGLTextures: Trying to use "+(T+1)+" texture units while this GPU supports only "+s.maxTextures),B+=1,T}function j(T){let g=[];return g.push(T.wrapS),g.push(T.wrapT),g.push(T.wrapR||0),g.push(T.magFilter),g.push(T.minFilter),g.push(T.anisotropy),g.push(T.internalFormat),g.push(T.format),g.push(T.type),g.push(T.generateMipmaps),g.push(T.premultiplyAlpha),g.push(T.flipY),g.push(T.unpackAlignment),g.push(T.colorSpace),g.join()}function ne(T,g){let O=n.get(T);if(T.isVideoTexture&&P(T),T.isRenderTargetTexture===!1&&T.isExternalTexture!==!0&&T.version>0&&O.__version!==T.version){let z=T.image;if(z===null)Oe("WebGLRenderer: Texture marked for update but no image data found.");else if(z.complete===!1)Oe("WebGLRenderer: Texture marked for update but image is incomplete");else{ie(O,T,g);return}}else T.isExternalTexture&&(O.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,O.__webglTexture,i.TEXTURE0+g)}function F(T,g){let O=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&O.__version!==T.version){ie(O,T,g);return}else T.isExternalTexture&&(O.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,O.__webglTexture,i.TEXTURE0+g)}function W(T,g){let O=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&O.__version!==T.version){ie(O,T,g);return}t.bindTexture(i.TEXTURE_3D,O.__webglTexture,i.TEXTURE0+g)}function J(T,g){let O=n.get(T);if(T.isCubeDepthTexture!==!0&&T.version>0&&O.__version!==T.version){Re(O,T,g);return}t.bindTexture(i.TEXTURE_CUBE_MAP,O.__webglTexture,i.TEXTURE0+g)}let oe={[fa]:i.REPEAT,[Sn]:i.CLAMP_TO_EDGE,[pa]:i.MIRRORED_REPEAT},re={[Pt]:i.NEAREST,[Ch]:i.NEAREST_MIPMAP_NEAREST,[nr]:i.NEAREST_MIPMAP_LINEAR,[Dt]:i.LINEAR,[Ha]:i.LINEAR_MIPMAP_NEAREST,[oi]:i.LINEAR_MIPMAP_LINEAR},le={[Lh]:i.NEVER,[Oh]:i.ALWAYS,[Dh]:i.LESS,[Co]:i.LEQUAL,[Nh]:i.EQUAL,[Ro]:i.GEQUAL,[Uh]:i.GREATER,[Fh]:i.NOTEQUAL};function Fe(T,g){if(g.type===on&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===Dt||g.magFilter===Ha||g.magFilter===nr||g.magFilter===oi||g.minFilter===Dt||g.minFilter===Ha||g.minFilter===nr||g.minFilter===oi)&&Oe("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(T,i.TEXTURE_WRAP_S,oe[g.wrapS]),i.texParameteri(T,i.TEXTURE_WRAP_T,oe[g.wrapT]),(T===i.TEXTURE_3D||T===i.TEXTURE_2D_ARRAY)&&i.texParameteri(T,i.TEXTURE_WRAP_R,oe[g.wrapR]),i.texParameteri(T,i.TEXTURE_MAG_FILTER,re[g.magFilter]),i.texParameteri(T,i.TEXTURE_MIN_FILTER,re[g.minFilter]),g.compareFunction&&(i.texParameteri(T,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(T,i.TEXTURE_COMPARE_FUNC,le[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===Pt||g.minFilter!==nr&&g.minFilter!==oi||g.type===on&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||n.get(g).__currentAnisotropy){let O=e.get("EXT_texture_filter_anisotropic");i.texParameterf(T,O.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,s.getMaxAnisotropy())),n.get(g).__currentAnisotropy=g.anisotropy}}}function Ne(T,g){let O=!1;T.__webglInit===void 0&&(T.__webglInit=!0,g.addEventListener("dispose",M));let z=g.source,K=m.get(z);K===void 0&&(K={},m.set(z,K));let ae=j(g);if(ae!==T.__cacheKey){K[ae]===void 0&&(K[ae]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,O=!0),K[ae].usedTimes++;let he=K[T.__cacheKey];he!==void 0&&(K[T.__cacheKey].usedTimes--,he.usedTimes===0&&A(g)),T.__cacheKey=ae,T.__webglTexture=K[ae].texture}return O}function q(T,g,O){return Math.floor(Math.floor(T/O)/g)}function Y(T,g,O,z){let ae=T.updateRanges;if(ae.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,g.width,g.height,O,z,g.data);else{ae.sort((Te,pe)=>Te.start-pe.start);let he=0;for(let Te=1;Te<ae.length;Te++){let pe=ae[he],de=ae[Te],Ae=pe.start+pe.count,De=q(de.start,g.width,4),Xe=q(pe.start,g.width,4);de.start<=Ae+1&&De===Xe&&q(de.start+de.count-1,g.width,4)===De?pe.count=Math.max(pe.count,de.start+de.count-pe.start):(++he,ae[he]=de)}ae.length=he+1;let Q=t.getParameter(i.UNPACK_ROW_LENGTH),te=t.getParameter(i.UNPACK_SKIP_PIXELS),ue=t.getParameter(i.UNPACK_SKIP_ROWS);t.pixelStorei(i.UNPACK_ROW_LENGTH,g.width);for(let Te=0,pe=ae.length;Te<pe;Te++){let de=ae[Te],Ae=Math.floor(de.start/4),De=Math.ceil(de.count/4),Xe=Ae%g.width,N=Math.floor(Ae/g.width),me=De,ee=1;t.pixelStorei(i.UNPACK_SKIP_PIXELS,Xe),t.pixelStorei(i.UNPACK_SKIP_ROWS,N),t.texSubImage2D(i.TEXTURE_2D,0,Xe,N,me,ee,O,z,g.data)}T.clearUpdateRanges(),t.pixelStorei(i.UNPACK_ROW_LENGTH,Q),t.pixelStorei(i.UNPACK_SKIP_PIXELS,te),t.pixelStorei(i.UNPACK_SKIP_ROWS,ue)}}function ie(T,g,O){let z=i.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(z=i.TEXTURE_2D_ARRAY),g.isData3DTexture&&(z=i.TEXTURE_3D);let K=Ne(T,g),ae=g.source;t.bindTexture(z,T.__webglTexture,i.TEXTURE0+O);let he=n.get(ae);if(ae.version!==he.__version||K===!0){if(t.activeTexture(i.TEXTURE0+O),(typeof ImageBitmap<"u"&&g.image instanceof ImageBitmap)===!1){let ee=Qe.getPrimaries(Qe.workingColorSpace),ge=g.colorSpace===Vn?null:Qe.getPrimaries(g.colorSpace),ve=g.colorSpace===Vn||ee===ge?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ve)}t.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment);let te=p(g.image,!1,s.maxTextureSize);te=vt(g,te);let ue=r.convert(g.format,g.colorSpace),Te=r.convert(g.type),pe=y(g.internalFormat,ue,Te,g.normalized,g.colorSpace,g.isVideoTexture);Fe(z,g);let de,Ae=g.mipmaps,De=g.isVideoTexture!==!0,Xe=he.__version===void 0||K===!0,N=ae.dataReady,me=v(g,te);if(g.isDepthTexture)pe=E(g.format===li,g.type),Xe&&(De?t.texStorage2D(i.TEXTURE_2D,1,pe,te.width,te.height):t.texImage2D(i.TEXTURE_2D,0,pe,te.width,te.height,0,ue,Te,null));else if(g.isDataTexture)if(Ae.length>0){De&&Xe&&t.texStorage2D(i.TEXTURE_2D,me,pe,Ae[0].width,Ae[0].height);for(let ee=0,ge=Ae.length;ee<ge;ee++)de=Ae[ee],De?N&&t.texSubImage2D(i.TEXTURE_2D,ee,0,0,de.width,de.height,ue,Te,de.data):t.texImage2D(i.TEXTURE_2D,ee,pe,de.width,de.height,0,ue,Te,de.data);g.generateMipmaps=!1}else De?(Xe&&t.texStorage2D(i.TEXTURE_2D,me,pe,te.width,te.height),N&&Y(g,te,ue,Te)):t.texImage2D(i.TEXTURE_2D,0,pe,te.width,te.height,0,ue,Te,te.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){De&&Xe&&t.texStorage3D(i.TEXTURE_2D_ARRAY,me,pe,Ae[0].width,Ae[0].height,te.depth);for(let ee=0,ge=Ae.length;ee<ge;ee++)if(de=Ae[ee],g.format!==ln)if(ue!==null)if(De){if(N)if(g.layerUpdates.size>0){let ve=$l(de.width,de.height,g.format,g.type);for(let se of g.layerUpdates){let Ie=de.data.subarray(se*ve/de.data.BYTES_PER_ELEMENT,(se+1)*ve/de.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,ee,0,0,se,de.width,de.height,1,ue,Ie)}}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,ee,0,0,0,de.width,de.height,te.depth,ue,de.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,ee,pe,de.width,de.height,te.depth,0,de.data,0,0);else Oe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else De?N&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,ee,0,0,0,de.width,de.height,te.depth,ue,Te,de.data):t.texImage3D(i.TEXTURE_2D_ARRAY,ee,pe,de.width,de.height,te.depth,0,ue,Te,de.data);g.layerUpdates.size>0&&g.clearLayerUpdates()}else{De&&Xe&&t.texStorage2D(i.TEXTURE_2D,me,pe,Ae[0].width,Ae[0].height);for(let ee=0,ge=Ae.length;ee<ge;ee++)de=Ae[ee],g.format!==ln?ue!==null?De?N&&t.compressedTexSubImage2D(i.TEXTURE_2D,ee,0,0,de.width,de.height,ue,de.data):t.compressedTexImage2D(i.TEXTURE_2D,ee,pe,de.width,de.height,0,de.data):Oe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):De?N&&t.texSubImage2D(i.TEXTURE_2D,ee,0,0,de.width,de.height,ue,Te,de.data):t.texImage2D(i.TEXTURE_2D,ee,pe,de.width,de.height,0,ue,Te,de.data)}else if(g.isDataArrayTexture)if(De){if(Xe&&t.texStorage3D(i.TEXTURE_2D_ARRAY,me,pe,te.width,te.height,te.depth),N)if(g.layerUpdates.size>0){let ee=$l(te.width,te.height,g.format,g.type);for(let ge of g.layerUpdates){let ve=te.data.subarray(ge*ee/te.data.BYTES_PER_ELEMENT,(ge+1)*ee/te.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,ge,te.width,te.height,1,ue,Te,ve)}g.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,te.width,te.height,te.depth,ue,Te,te.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,pe,te.width,te.height,te.depth,0,ue,Te,te.data);else if(g.isData3DTexture)De?(Xe&&t.texStorage3D(i.TEXTURE_3D,me,pe,te.width,te.height,te.depth),N&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,te.width,te.height,te.depth,ue,Te,te.data)):t.texImage3D(i.TEXTURE_3D,0,pe,te.width,te.height,te.depth,0,ue,Te,te.data);else if(g.isFramebufferTexture){if(Xe)if(De)t.texStorage2D(i.TEXTURE_2D,me,pe,te.width,te.height);else{let ee=te.width,ge=te.height;for(let ve=0;ve<me;ve++)t.texImage2D(i.TEXTURE_2D,ve,pe,ee,ge,0,ue,Te,null),ee>>=1,ge>>=1}}else if(g.isHTMLTexture){if("texElementImage2D"in i){let ee=i.canvas;if(ee.hasAttribute("layoutsubtree")||ee.setAttribute("layoutsubtree","true"),te.parentNode!==ee){ee.appendChild(te),d.add(g),ee.onpaint=ge=>{let ve=ge.changedElements;for(let se of d)ve.includes(se.image)&&(se.needsUpdate=!0)},ee.requestPaint();return}if(i.texElementImage2D.length===3)i.texElementImage2D(i.TEXTURE_2D,i.RGBA8,te);else{let ve=i.RGBA,se=i.RGBA,Ie=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,0,ve,se,Ie,te)}i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Ae.length>0){if(De&&Xe){let ee=nt(Ae[0]);t.texStorage2D(i.TEXTURE_2D,me,pe,ee.width,ee.height)}for(let ee=0,ge=Ae.length;ee<ge;ee++)de=Ae[ee],De?N&&t.texSubImage2D(i.TEXTURE_2D,ee,0,0,ue,Te,de):t.texImage2D(i.TEXTURE_2D,ee,pe,ue,Te,de);g.generateMipmaps=!1}else if(De){if(Xe){let ee=nt(te);t.texStorage2D(i.TEXTURE_2D,me,pe,ee.width,ee.height)}N&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ue,Te,te)}else t.texImage2D(i.TEXTURE_2D,0,pe,ue,Te,te);f(g)&&C(z),he.__version=ae.version,g.onUpdate&&g.onUpdate(g)}T.__version=g.version}function Re(T,g,O){if(g.image.length!==6)return;let z=Ne(T,g),K=g.source;t.bindTexture(i.TEXTURE_CUBE_MAP,T.__webglTexture,i.TEXTURE0+O);let ae=n.get(K);if(K.version!==ae.__version||z===!0){t.activeTexture(i.TEXTURE0+O);let he=Qe.getPrimaries(Qe.workingColorSpace),Q=g.colorSpace===Vn?null:Qe.getPrimaries(g.colorSpace),te=g.colorSpace===Vn||he===Q?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),t.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,te);let ue=g.isCompressedTexture||g.image[0].isCompressedTexture,Te=g.image[0]&&g.image[0].isDataTexture,pe=[];for(let se=0;se<6;se++)!ue&&!Te?pe[se]=p(g.image[se],!0,s.maxCubemapSize):pe[se]=Te?g.image[se].image:g.image[se],pe[se]=vt(g,pe[se]);let de=pe[0],Ae=r.convert(g.format,g.colorSpace),De=r.convert(g.type),Xe=y(g.internalFormat,Ae,De,g.normalized,g.colorSpace),N=g.isVideoTexture!==!0,me=ae.__version===void 0||z===!0,ee=K.dataReady,ge=v(g,de);Fe(i.TEXTURE_CUBE_MAP,g);let ve;if(ue){N&&me&&t.texStorage2D(i.TEXTURE_CUBE_MAP,ge,Xe,de.width,de.height);for(let se=0;se<6;se++){ve=pe[se].mipmaps;for(let Ie=0;Ie<ve.length;Ie++){let Ce=ve[Ie];g.format!==ln?Ae!==null?N?ee&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,Ie,0,0,Ce.width,Ce.height,Ae,Ce.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,Ie,Xe,Ce.width,Ce.height,0,Ce.data):Oe("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):N?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,Ie,0,0,Ce.width,Ce.height,Ae,De,Ce.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,Ie,Xe,Ce.width,Ce.height,0,Ae,De,Ce.data)}}}else{if(ve=g.mipmaps,N&&me){ve.length>0&&ge++;let se=nt(pe[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,ge,Xe,se.width,se.height)}for(let se=0;se<6;se++)if(Te){N?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,0,0,pe[se].width,pe[se].height,Ae,De,pe[se].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,Xe,pe[se].width,pe[se].height,0,Ae,De,pe[se].data);for(let Ie=0;Ie<ve.length;Ie++){let gt=ve[Ie].image[se].image;N?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,Ie+1,0,0,gt.width,gt.height,Ae,De,gt.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,Ie+1,Xe,gt.width,gt.height,0,Ae,De,gt.data)}}else{N?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,0,0,Ae,De,pe[se]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,Xe,Ae,De,pe[se]);for(let Ie=0;Ie<ve.length;Ie++){let Ce=ve[Ie];N?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,Ie+1,0,0,Ae,De,Ce.image[se]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,Ie+1,Xe,Ae,De,Ce.image[se])}}}f(g)&&C(i.TEXTURE_CUBE_MAP),ae.__version=K.version,g.onUpdate&&g.onUpdate(g)}T.__version=g.version}function ce(T,g,O,z,K,ae){let he=r.convert(O.format,O.colorSpace),Q=r.convert(O.type),te=y(O.internalFormat,he,Q,O.normalized,O.colorSpace),ue=n.get(g),Te=n.get(O);if(Te.__renderTarget=g,!ue.__hasExternalTextures){let pe=Math.max(1,g.width>>ae),de=Math.max(1,g.height>>ae);K===i.TEXTURE_3D||K===i.TEXTURE_2D_ARRAY?t.texImage3D(K,ae,te,pe,de,g.depth,0,he,Q,null):t.texImage2D(K,ae,te,pe,de,0,he,Q,null)}t.bindFramebuffer(i.FRAMEBUFFER,T),$e(g)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,z,K,Te.__webglTexture,0,Je(g)):(K===i.TEXTURE_2D||K>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&K<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,z,K,Te.__webglTexture,ae),t.bindFramebuffer(i.FRAMEBUFFER,null)}function Ue(T,g,O){if(i.bindRenderbuffer(i.RENDERBUFFER,T),g.depthBuffer){let z=g.depthTexture,K=z&&z.isDepthTexture?z.type:null,ae=E(g.stencilBuffer,K),he=g.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;$e(g)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Je(g),ae,g.width,g.height):O?i.renderbufferStorageMultisample(i.RENDERBUFFER,Je(g),ae,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,ae,g.width,g.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,he,i.RENDERBUFFER,T)}else{let z=g.textures;for(let K=0;K<z.length;K++){let ae=z[K],he=r.convert(ae.format,ae.colorSpace),Q=r.convert(ae.type),te=y(ae.internalFormat,he,Q,ae.normalized,ae.colorSpace);$e(g)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Je(g),te,g.width,g.height):O?i.renderbufferStorageMultisample(i.RENDERBUFFER,Je(g),te,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,te,g.width,g.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function rt(T,g,O){let z=g.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,T),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let K=n.get(g.depthTexture);if(K.__renderTarget=g,(!K.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),z){if(K.__webglInit===void 0&&(K.__webglInit=!0,g.depthTexture.addEventListener("dispose",M)),K.__webglTexture===void 0){K.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,K.__webglTexture),Fe(i.TEXTURE_CUBE_MAP,g.depthTexture);let ue=r.convert(g.depthTexture.format),Te=r.convert(g.depthTexture.type),pe;g.depthTexture.format===Mn?pe=i.DEPTH_COMPONENT24:g.depthTexture.format===li&&(pe=i.DEPTH24_STENCIL8);for(let de=0;de<6;de++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+de,0,pe,g.width,g.height,0,ue,Te,null)}}else ne(g.depthTexture,0);let ae=K.__webglTexture,he=Je(g),Q=z?i.TEXTURE_CUBE_MAP_POSITIVE_X+O:i.TEXTURE_2D,te=g.depthTexture.format===li?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(g.depthTexture.format===Mn)$e(g)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,te,Q,ae,0,he):i.framebufferTexture2D(i.FRAMEBUFFER,te,Q,ae,0);else if(g.depthTexture.format===li)$e(g)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,te,Q,ae,0,he):i.framebufferTexture2D(i.FRAMEBUFFER,te,Q,ae,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function Ye(T){let g=n.get(T),O=T.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==T.depthTexture){let z=T.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),z){let K=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,z.removeEventListener("dispose",K)};z.addEventListener("dispose",K),g.__depthDisposeCallback=K}g.__boundDepthTexture=z}if(T.depthTexture&&!g.__autoAllocateDepthBuffer)if(O)for(let z=0;z<6;z++)rt(g.__webglFramebuffer[z],T,z);else{let z=T.texture.mipmaps;z&&z.length>0?rt(g.__webglFramebuffer[0],T,0):rt(g.__webglFramebuffer,T,0)}else if(O){g.__webglDepthbuffer=[];for(let z=0;z<6;z++)if(t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[z]),g.__webglDepthbuffer[z]===void 0)g.__webglDepthbuffer[z]=i.createRenderbuffer(),Ue(g.__webglDepthbuffer[z],T,!1);else{let K=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ae=g.__webglDepthbuffer[z];i.bindRenderbuffer(i.RENDERBUFFER,ae),i.framebufferRenderbuffer(i.FRAMEBUFFER,K,i.RENDERBUFFER,ae)}}else{let z=T.texture.mipmaps;if(z&&z.length>0?t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=i.createRenderbuffer(),Ue(g.__webglDepthbuffer,T,!1);else{let K=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ae=g.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,ae),i.framebufferRenderbuffer(i.FRAMEBUFFER,K,i.RENDERBUFFER,ae)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function fe(T,g,O){let z=n.get(T);g!==void 0&&ce(z.__webglFramebuffer,T,T.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),O!==void 0&&Ye(T)}function Be(T){let g=T.texture,O=n.get(T),z=n.get(g);T.addEventListener("dispose",x);let K=T.textures,ae=T.isWebGLCubeRenderTarget===!0,he=K.length>1;if(he||(z.__webglTexture===void 0&&(z.__webglTexture=i.createTexture()),z.__version=g.version,o.memory.textures++),ae){O.__webglFramebuffer=[];for(let Q=0;Q<6;Q++)if(g.mipmaps&&g.mipmaps.length>0){O.__webglFramebuffer[Q]=[];for(let te=0;te<g.mipmaps.length;te++)O.__webglFramebuffer[Q][te]=i.createFramebuffer()}else O.__webglFramebuffer[Q]=i.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){O.__webglFramebuffer=[];for(let Q=0;Q<g.mipmaps.length;Q++)O.__webglFramebuffer[Q]=i.createFramebuffer()}else O.__webglFramebuffer=i.createFramebuffer();if(he)for(let Q=0,te=K.length;Q<te;Q++){let ue=n.get(K[Q]);ue.__webglTexture===void 0&&(ue.__webglTexture=i.createTexture(),o.memory.textures++)}if(T.samples>0&&$e(T)===!1){O.__webglMultisampledFramebuffer=i.createFramebuffer(),O.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let Q=0;Q<K.length;Q++){let te=K[Q];O.__webglColorRenderbuffer[Q]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,O.__webglColorRenderbuffer[Q]);let ue=r.convert(te.format,te.colorSpace),Te=r.convert(te.type),pe=y(te.internalFormat,ue,Te,te.normalized,te.colorSpace,T.isXRRenderTarget===!0),de=Je(T);i.renderbufferStorageMultisample(i.RENDERBUFFER,de,pe,T.width,T.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Q,i.RENDERBUFFER,O.__webglColorRenderbuffer[Q])}i.bindRenderbuffer(i.RENDERBUFFER,null),T.depthBuffer&&(O.__webglDepthRenderbuffer=i.createRenderbuffer(),Ue(O.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ae){t.bindTexture(i.TEXTURE_CUBE_MAP,z.__webglTexture),Fe(i.TEXTURE_CUBE_MAP,g);for(let Q=0;Q<6;Q++)if(g.mipmaps&&g.mipmaps.length>0)for(let te=0;te<g.mipmaps.length;te++)ce(O.__webglFramebuffer[Q][te],T,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,te);else ce(O.__webglFramebuffer[Q],T,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0);f(g)&&C(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(he){for(let Q=0,te=K.length;Q<te;Q++){let ue=K[Q],Te=n.get(ue),pe=i.TEXTURE_2D;(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(pe=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(pe,Te.__webglTexture),Fe(pe,ue),ce(O.__webglFramebuffer,T,ue,i.COLOR_ATTACHMENT0+Q,pe,0),f(ue)&&C(pe)}t.unbindTexture()}else{let Q=i.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(Q=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(Q,z.__webglTexture),Fe(Q,g),g.mipmaps&&g.mipmaps.length>0)for(let te=0;te<g.mipmaps.length;te++)ce(O.__webglFramebuffer[te],T,g,i.COLOR_ATTACHMENT0,Q,te);else ce(O.__webglFramebuffer,T,g,i.COLOR_ATTACHMENT0,Q,0);f(g)&&C(Q),t.unbindTexture()}T.depthBuffer&&Ye(T)}function Me(T){let g=T.textures;for(let O=0,z=g.length;O<z;O++){let K=g[O];if(f(K)){let ae=R(T),he=n.get(K).__webglTexture;t.bindTexture(ae,he),C(ae),t.unbindTexture()}}}let Ge=[],We=[];function mt(T){if(T.samples>0){if($e(T)===!1){let g=T.textures,O=T.width,z=T.height,K=i.COLOR_BUFFER_BIT,ae=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,he=n.get(T),Q=g.length>1;if(Q)for(let ue=0;ue<g.length;ue++)t.bindFramebuffer(i.FRAMEBUFFER,he.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ue,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,he.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ue,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,he.__webglMultisampledFramebuffer);let te=T.texture.mipmaps;te&&te.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,he.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,he.__webglFramebuffer);for(let ue=0;ue<g.length;ue++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(K|=i.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(K|=i.STENCIL_BUFFER_BIT)),Q){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,he.__webglColorRenderbuffer[ue]);let Te=n.get(g[ue]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Te,0)}i.blitFramebuffer(0,0,O,z,0,0,O,z,K,i.NEAREST),c===!0&&(Ge.length=0,We.length=0,Ge.push(i.COLOR_ATTACHMENT0+ue),T.depthBuffer&&T.storeMultisampledDepthBuffer===!1&&(Ge.push(ae),We.push(ae),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,We)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Ge))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),Q)for(let ue=0;ue<g.length;ue++){t.bindFramebuffer(i.FRAMEBUFFER,he.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ue,i.RENDERBUFFER,he.__webglColorRenderbuffer[ue]);let Te=n.get(g[ue]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,he.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ue,i.TEXTURE_2D,Te,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,he.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.storeMultisampledDepthBuffer===!1&&c){let g=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[g])}}}function Je(T){return Math.min(s.maxSamples,T.samples)}function $e(T){let g=n.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function P(T){let g=o.render.frame;u.get(T)!==g&&(u.set(T,g),T.update())}function vt(T,g){let O=T.colorSpace,z=T.format,K=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||O!==As&&O!==Vn&&(Qe.getTransfer(O)===ht?(z!==ln||K!==Zt)&&Oe("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):ke("WebGLTextures: Unsupported texture color space:",O)),g}function nt(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(l.width=T.naturalWidth||T.width,l.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(l.width=T.displayWidth,l.height=T.displayHeight):(l.width=T.width,l.height=T.height),l}this.allocateTextureUnit=$,this.resetTextureUnits=G,this.getTextureUnits=D,this.setTextureUnits=X,this.setTexture2D=ne,this.setTexture2DArray=F,this.setTexture3D=W,this.setTextureCube=J,this.rebindTextures=fe,this.setupRenderTarget=Be,this.updateRenderTargetMipmap=Me,this.updateMultisampleRenderTarget=mt,this.setupDepthRenderbuffer=Ye,this.setupFrameBufferTexture=ce,this.useMultisampledRTT=$e,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function W0(i,e){function t(n,s=Vn){let r,o=Qe.getTransfer(s);if(n===Zt)return i.UNSIGNED_BYTE;if(n===Wa)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Xa)return i.UNSIGNED_SHORT_5_5_5_1;if(n===zl)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Vl)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Bl)return i.BYTE;if(n===kl)return i.SHORT;if(n===as)return i.UNSIGNED_SHORT;if(n===Ga)return i.INT;if(n===_n)return i.UNSIGNED_INT;if(n===on)return i.FLOAT;if(n===xn)return i.HALF_FLOAT;if(n===Hl)return i.ALPHA;if(n===Gl)return i.RGB;if(n===ln)return i.RGBA;if(n===Mn)return i.DEPTH_COMPONENT;if(n===li)return i.DEPTH_STENCIL;if(n===Ya)return i.RED;if(n===qa)return i.RED_INTEGER;if(n===ci)return i.RG;if(n===Za)return i.RG_INTEGER;if(n===Ja)return i.RGBA_INTEGER;if(n===ir||n===sr||n===rr||n===ar)if(o===ht)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===ir)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===sr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===rr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===ar)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===ir)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===sr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===rr)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===ar)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Ka||n===$a||n===ja||n===Qa)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Ka)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===$a)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===ja)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Qa)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===eo||n===to||n===no||n===io||n===so||n===or||n===ro)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===eo||n===to)return o===ht?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===no)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===io)return r.COMPRESSED_R11_EAC;if(n===so)return r.COMPRESSED_SIGNED_R11_EAC;if(n===or)return r.COMPRESSED_RG11_EAC;if(n===ro)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===ao||n===oo||n===lo||n===co||n===ho||n===uo||n===fo||n===po||n===mo||n===go||n===_o||n===xo||n===yo||n===vo)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===ao)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===oo)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===lo)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===co)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===ho)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===uo)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===fo)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===po)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===mo)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===go)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===_o)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===xo)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===yo)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===vo)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===bo||n===So||n===Mo)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===bo)return o===ht?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===So)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Mo)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Eo||n===wo||n===lr||n===To)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Eo)return r.COMPRESSED_RED_RGTC1_EXT;if(n===wo)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===lr)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===To)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===os?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}var X0=`
void main() {
...
`;function F_(){if(typeof document>"u"||document.getElementById("dsh-cad-scene-import-styles"))return;let i=document.createElement("style");i.id="dsh-cad-scene-import-styles",i.textContent=U_,document.head.appendChild(i)}function fs(i){return"#"+(i>>>0).toString(16).padStart(6,"0")}var Go=class extends tt.Component{constructor(e){super(e),this.state={error:null}}static getDerivedStateFromError(e){return{error:e}}componentDidCatch(e){console.error("[dsh-cad-scene] render error",e)}render(){return this.state.error?(0,k.jsxs)("div",{style:{padding:24,color:"#f87171",fontSize:13},children:["dsh-cad-scene \u6E32\u67D3\u51FA\u9519\uFF1A",String(this.state.error&&this.state.error.message||this.state.error)]}):this.props.children}};function zu(i,e){if(!i||e==null)return null;let t=String(e);for(let n of i.devices||[])if((n.handles||[]).some(s=>String(s)===t))return n;return null}function Vu(i){if(!i)return null;let e=new Set;if(i.item&&(e.add(i.item.id),i.item.handle!=null&&e.add(String(i.item.handle))),i.device){e.add(i.device.id);for(let t of i.device.handles||[])e.add(String(t))}return e.size>0?e:null}function Hu({scene:i,selection:e}){if(!e||!e.item&&!e.device)return(0,k.jsx)("div",{style:ot.info,children:"\u70B9\u51FB\u573A\u666F\u4E2D\u7684\u5B9E\u4F53\u6216\u8BBE\u5907\u6E05\u5355\u6761\u76EE\u67E5\u770B\u8BE6\u60C5"});let t=e.device,n=e.item,s=e.category,r=Array.isArray(i.layers)?i.layers:[],o=n?n.layer:t?t.layer:null,a=r.find(u=>u&&u.name===o)||null,c=(Array.isArray(i.entities)?i.entities:[]).filter(u=>u&&(u.type==="TEXT"||u.type==="MTEXT")&&u.layer===o&&u.text).slice(0,6),l=n&&(n.position||n.center||Array.isArray(n.vertices)&&n.vertices[0])||null;return(0,k.jsxs)("div",{style:ot.info,children:[t?(0,k.jsxs)("div",{children:[(0,k.jsxs)("div",{children:[(0,k.jsx)("span",{style:ot.label,children:"\u8BBE\u5907"}),(0,k.jsx)("strong",{children:t.name||t.id}),t.name?" \xB7 "+t.id:""]}),(0,k.jsxs)("div",{children:[(0,k.jsx)("span",{style:ot.label,children:"\u7C7B\u578B"}),t.type,t.blockName?" \xB7 \u5757 "+t.blockName:""]}),(0,k.jsxs)("div",{children:[(0,k.jsx)("span",{style:ot.label,children:"\u56FE\u5C42"}),t.layer]}),(0,k.jsxs)("div",{children:[(0,k.jsx)("span",{style:ot.label,children:"\u5C3A\u5BF8"}),Math.round(t.size.width*10)/10," \xD7 ",Math.round(t.size.depth*10)/10]}),(0,k.jsxs)("div",{children:[(0,k.jsx)("span",{style:ot.label,children:"\u56FE\u5143"}),t.entityCount," \u4E2A"]})]}):null,n?(0,k.jsxs)("div",{children:[(0,k.jsxs)("div",{children:[(0,k.jsx)("span",{style:ot.label,children:"\u5B9E\u4F53"}),(0,k.jsx)("strong",{children:n.id})," \xB7 ",n.type,s?` \xB7 ${Bu[s]}`:""]}),(0,k.jsxs)("div",{children:[(0,k.jsx)("span",{style:ot.label,children:"\u56FE\u5C42"}),n.layer,a?(0,k.jsxs)("span",{style:{marginLeft:8,opacity:.8},children:[a.visible===!1?"\u9690\u85CF":"\u53EF\u89C1",a.frozen?" \xB7 \u51BB\u7ED3":""]}):null]}),n.block?(0,k.jsxs)("div",{children:[(0,k.jsx)("span",{style:ot.label,children:"\u5757\u5F15\u7528"}),n.block]}):null,l?(0,k.jsxs)("div",{children:[(0,k.jsx)("span",{style:ot.label,children:"\u4F4D\u7F6E"}),"(",Math.round(l.x*100)/100,", ",Math.round(l.y*100)/100,")"]}):null,n.text?(0,k.jsxs)("div",{children:[(0,k.jsx)("span",{style:ot.label,children:"\u6587\u672C"}),n.text]}):null]}):null,c.length>0?(0,k.jsxs)("div",{children:[(0,k.jsx)("span",{style:ot.label,children:"\u540C\u5C42\u6587\u672C"}),c.map((u,d)=>(0,k.jsx)("div",{style:{paddingLeft:12},children:u.text},d))]}):null]})}function O_({scene:i}){let e=i.meta||{};return(0,k.jsxs)("div",{style:ot.summary,children:[(0,k.jsx)("span",{children:e.source||"CAD scene"}),e.format?(0,k.jsx)("span",{style:{opacity:.6},children:e.format}):null,["racks","aisles","zones","agvs"].map(t=>(0,k.jsxs)("span",{style:ot.chip,children:[(0,k.jsx)("span",{style:ot.dot(fs(R_[t]))}),Bu[t]," ",(i[t]||[]).length||(e.summary&&e.summary.classified?e.summary.classified[t]:0)]},t)),typeof e.entityCount=="number"?(0,k.jsxs)("span",{style:{opacity:.6},children:["\u5B9E\u4F53 ",e.entityCount]}):null,e.truncated?(0,k.jsx)("span",{style:{opacity:.6},children:"(\u5DF2\u622A\u65AD)"}):null]})}function Fu(i){try{let e=localStorage.getItem("dsh-cad-scene:groups"),t=e?JSON.parse(e):{};return t[i]&&typeof t[i]=="object"?t[i]:{}}catch{return{}}}function B_(i,e){try{let t=localStorage.getItem("dsh-cad-scene:groups"),n=t?JSON.parse(t):{};n[i]=e,localStorage.setItem("dsh-cad-scene:groups",JSON.stringify(n))}catch{}}function k_({scene:i,hiddenLayers:e,onToggleLayer:t}){let n=String(i.meta&&i.meta.source||"")+"|"+(i.entities||[]).length,[s,r]=(0,tt.useState)(()=>Fu(n)),[o,a]=(0,tt.useState)(null),[c,l]=(0,tt.useState)("");(0,tt.useEffect)(()=>{r(Fu(n)),a(null),l("")},[n]);let u=(y,E)=>{let v=Object.assign({},s),M=String(E||"").trim();M===""||M===y?delete v[y]:v[y]=M,r(v),B_(n,v),a(null),l("")},d={};for(let y of i.entities||[])d[y.layer]=(d[y.layer]||0)+1;let h={};for(let y of i.layers||[])h[y.name]=y;let m=Object.keys(d);for(let y of i.layers||[])d[y.name]===void 0&&m.push(y.name);let _={};for(let y of m){let E=s[y]||y;_[E]||(_[E]={name:E,layers:[],count:0,color:fs(Si(i,y))}),_[E].layers.push(y),_[E].count+=d[y]||0}let S=Object.keys(_).map(y=>_[y]).sort((y,E)=>E.count-y.count),p=Object.keys(_).sort(),f=y=>{let E=y.layers.some(v=>!e[v]);for(let v of y.layers)E!==!!e[v]&&t(v)},C=y=>(0,k.jsxs)("div",{className:"cad-p-edit",onClick:E=>E.stopPropagation(),children:[(0,k.jsx)("input",{list:"cad-p-group-options",value:c,placeholder:"\u5408\u5E76\u5230\u7EC4\u540D\uFF08\u7559\u7A7A=\u72EC\u7ACB\uFF09",onChange:E=>l(E.target.value),onKeyDown:E=>{E.key==="Enter"&&u(y,c)},autoFocus:!0}),(0,k.jsx)("datalist",{id:"cad-p-group-options",children:p.map(E=>(0,k.jsx)("option",{value:E},E))}),(0,k.jsx)("button",{type:"button",className:"cad-p-mini",onClick:()=>u(y,c),children:"\u2713"}),(0,k.jsx)("button",{type:"button",className:"cad-p-mini",onClick:()=>a(null),children:"\u2715"})]}),R=(y,E)=>{let v=h[y];return(0,k.jsxs)("div",{children:[(0,k.jsxs)("div",{className:E?"cad-p-layer cad-p-gm":"cad-p-layer","data-off":e[y]?"true":"false",onClick:()=>t(y),children:[(0,k.jsx)("span",{className:"cad-p-dot",style:{background:fs(Si(i,y))}}),(0,k.jsx)("span",{className:"nm",children:y}),v&&v.visible===!1?(0,k.jsx)("span",{className:"cad-p-badge",children:"\u9690\u85CF"}):null,v&&v.frozen?(0,k.jsx)("span",{className:"cad-p-badge",children:"\u51BB\u7ED3"}):null,(0,k.jsx)("span",{className:"cnt",children:d[y]||0}),(0,k.jsx)("button",{type:"button",className:"cad-p-mini",onClick:M=>{M.stopPropagation(),l(s[y]&&s[y]!==y?s[y]:""),a(o===y?null:y)},children:"\u270E"})]}),o===y?C(y):null]},y)};return(0,k.jsxs)("div",{className:"cad-p-card",children:[(0,k.jsxs)("h4",{children:["\u56FE\u4F8B \xB7 \u6309\u89E3\u6790\u5185\u5BB9\u751F\u6210\uFF08",S.length," \u7EC4 \xB7 \u270E \u53EF\u5408\u5E76/\u547D\u540D\uFF09"]}),(0,k.jsxs)("div",{className:"cad-p-layers",style:{maxHeight:300},children:[S.map(y=>{if(y.layers.length===1)return R(y.layers[0],!1);let E=y.layers.every(v=>!!e[v]);return(0,k.jsxs)("div",{children:[(0,k.jsxs)("div",{className:"cad-p-layer","data-off":E?"true":"false",onClick:()=>f(y),children:[(0,k.jsx)("span",{className:"cad-p-dot",style:{background:y.color}}),(0,k.jsx)("span",{className:"nm",children:(0,k.jsx)("b",{children:y.name})}),(0,k.jsx)("span",{className:"cnt",children:y.count})]}),y.layers.map(v=>R(v,!0))]},y.name)}),S.length===0?(0,k.jsx)("div",{style:{opacity:.6},children:"\u65E0\u56FE\u5C42\u5185\u5BB9"}):null]})]})}var Ho=["#60a5fa","#f97316","#34d399","#f472b6","#a78bfa","#facc15","#22d3ee","#fb7185","#94a3b8"];function z_({scene:i,selection:e,onSelect:t}){let[n,s]=(0,tt.useState)(""),r=i.devices||[],o=n.trim().toLowerCase(),a=o===""?r:r.filter(l=>String(l.name||"").toLowerCase().includes(o)||String(l.id).includes(o)||String(l.layer).toLowerCase().includes(o)),c=a.slice(0,300);return(0,k.jsxs)("div",{className:"cad-p-card",children:[(0,k.jsxs)("h4",{children:["\u8BBE\u5907\u6E05\u5355 \xB7 ",r.length," \u53F0\uFF08\u70B9\u51FB\u9009\u4E2D\u6574\u53F0\uFF09"]}),(0,k.jsx)("input",{className:"cad-p-edit-input",placeholder:"\u641C\u7D22 \u540D\u79F0/\u7F16\u53F7/\u56FE\u5C42\u2026",value:n,onChange:l=>s(l.target.value)}),(0,k.jsxs)("div",{className:"cad-p-layers",style:{maxHeight:260,marginTop:6},children:[c.map(l=>{let u=e&&e.device&&e.device.id===l.id;return(0,k.jsxs)("div",{className:"cad-p-layer","data-sel":u?"true":"false",onClick:()=>t(l),children:[(0,k.jsx)("span",{className:"cad-p-dot",style:{background:fs(Si(i,l.layer))}}),(0,k.jsx)("span",{className:"nm",children:l.name||l.id}),(0,k.jsx)("span",{className:"cnt",children:l.entityCount})]},l.id)}),a.length===0?(0,k.jsx)("div",{style:{opacity:.6},children:"\u65E0\u5339\u914D\u8BBE\u5907"}):null,a.length>c.length?(0,k.jsxs)("div",{style:{opacity:.6,padding:"2px 6px"},children:["\u2026\u8FD8\u6709 ",a.length-c.length," \u53F0\uFF08\u7F29\u5C0F\u641C\u7D22\u8303\u56F4\uFF09"]}):null]})]})}function V_({scene:i}){let e=i.meta||{},t={},n=1/0,s=1/0,r=-1/0,o=-1/0,a=d=>{d&&(n=Math.min(n,d.x),s=Math.min(s,d.y),r=Math.max(r,d.x),o=Math.max(o,d.y))};for(let d of i.entities||[]){t[d.type]=(t[d.type]||0)+1,a(d.position),a(d.center);for(let h of d.vertices||[])a(h);for(let h of(d.controlPoints||[]).concat(d.fitPoints||[],d.points||[]))a(h)}let c=n<1/0?{w:r-n,h:o-s}:null,l=Object.entries(t).sort((d,h)=>h[1]-d[1]),u=l.reduce((d,h)=>d+h[1],0)||1;return(0,k.jsxs)("div",{className:"cad-p-card",children:[(0,k.jsx)("h4",{children:"\u56FE\u7EB8\u7EDF\u8BA1"}),(0,k.jsxs)("div",{className:"cad-p-row",children:[(0,k.jsx)("span",{className:"k",children:"\u5B9E\u4F53\u603B\u6570"}),(0,k.jsx)("b",{children:e.entityCount!==void 0?e.entityCount:(i.entities||[]).length})]}),(0,k.jsxs)("div",{className:"cad-p-row",children:[(0,k.jsx)("span",{className:"k",children:"\u8BBE\u5907\u6570"}),(0,k.jsx)("b",{children:(i.devices||[]).length})]}),e.truncated?(0,k.jsx)("div",{className:"cad-p-logline cad-p-warn",children:"\u26A0 \u5B9E\u4F53\u8D85\u4E0A\u9650\u5DF2\u622A\u65AD"}):null,(0,k.jsx)("div",{className:"cad-p-bar",children:l.map((d,h)=>(0,k.jsx)("span",{style:{width:d[1]/u*100+"%",background:Ho[h%Ho.length]}},d[0]))}),(0,k.jsx)("div",{className:"cad-p-types",children:l.map((d,h)=>(0,k.jsxs)("span",{className:"cad-p-type",children:[(0,k.jsx)("i",{style:{color:Ho[h%Ho.length],fontStyle:"normal"},children:"\u25A0"})," ",d[0],"\xD7",d[1]]},d[0]))}),c?(0,k.jsxs)("div",{className:"cad-p-row",style:{marginTop:6},children:[(0,k.jsx)("span",{className:"k",children:"\u56FE\u5E45\u8303\u56F4"}),(0,k.jsxs)("b",{children:[Math.round(c.w*10)/10," \xD7 ",Math.round(c.h*10)/10]})]}):null,(0,k.jsxs)("div",{className:"cad-p-row",children:[(0,k.jsx)("span",{className:"k",children:"\u5757\u5B9A\u4E49"}),(0,k.jsx)("b",{children:(e.blocks||[]).length})]})]})}var H_=new Set(["INSERT","LINE","LWPOLYLINE","POLYLINE","ARC","CIRCLE","TEXT","MTEXT","POINT"]);function G_({scene:i}){let[e,t]=(0,tt.useState)(!1),n=i.meta||{},s={};for(let l of i.entities||[])H_.has(l.type)||(s[l.type]=(s[l.type]||0)+1);let r=[],o=String(n.format||"dxf");r.push({kind:"info",text:"\u89E3\u6790\u683C\u5F0F: "+o+(o.indexOf("dwg")===0?"\uFF08\u7ECF\u5916\u90E8\u8F6C\u6362\u5668\uFF09":"\uFF08\u6D4F\u89C8\u5668\u5185\u89E3\u6790\uFF09")}),n.truncated&&r.push({kind:"warn",text:"\u5B9E\u4F53\u8D85\u4E0A\u9650\u5DF2\u622A\u65AD\uFF0C\u4EC5\u4FDD\u7559\u524D "+(i.entities||[]).length+" \u4E2A"}),n.unclassified>0&&r.push({kind:"warn",text:"\u672A\u5206\u7C7B\u5B9E\u4F53 "+n.unclassified+" \u4E2A\uFF08\u672A\u5339\u914D\u5206\u7C7B\u8BCD\u8868\uFF0C\u5DF2\u6309\u56FE\u5C42\u8272\u7ED8\u5236\uFF09"});let a=Object.entries(s);a.length>0&&r.push({kind:"warn",text:"\u4E24\u4FA7\u89C6\u56FE\u5747\u672A\u7ED8\u5236: "+a.map(l=>l[0]+"\xD7"+l[1]).join("\u3001")}),r.push({kind:"info",text:"\u56FE\u5C42 "+(i.layers||[]).length+" \u4E2A \xB7 \u5757\u5B9A\u4E49 "+(n.blocks||[]).length+" \u4E2A"}),n.source&&r.push({kind:"info",text:n.source});let c=r.filter(l=>l.kind==="warn").length;return(0,k.jsxs)("div",{className:"cad-p-card cad-p-log","data-open":e?"true":"false",children:[(0,k.jsxs)("div",{className:"cad-p-log-toggle",onClick:()=>t(!e),children:[(0,k.jsx)("span",{className:"chev",children:"\u25B6"}),(0,k.jsx)("h4",{style:{margin:0,flex:1},children:"\u89E3\u6790\u65E5\u5FD7"}),(0,k.jsx)("span",{className:"cnt",children:c>0?c+" \u9879\u63D0\u793A":"\u6B63\u5E38"})]}),e?(0,k.jsx)("div",{style:{marginTop:8},children:r.map((l,u)=>(0,k.jsxs)("div",{className:"cad-p-logline"+(l.kind==="warn"?" cad-p-warn":""),children:[(0,k.jsx)("span",{children:l.kind==="warn"?"\u26A0":"\u2139"}),(0,k.jsx)("span",{children:l.text})]},u))}):null]})}function W_(i,e,t){let n=i.type;if(n==="LINE"||n==="LWPOLYLINE"||n==="POLYLINE"){let s=(i.vertices||[]).filter(r=>r&&typeof r.x=="number");return s.length<2?null:{item:i,category:e,color:t,kind:"poly",pts:i.closed&&s.length>2?s.concat([s[0]]):s}}return n==="CIRCLE"&&i.center?{item:i,category:e,color:t,kind:"circle",c:i.center,r:i.radius||1}:n==="ARC"&&i.center?{item:i,category:e,color:t,kind:"arc",c:i.center,r:i.radius||1,a0:i.startAngle||0,a1:i.endAngle!=null?i.endAngle:Math.PI}:i.position?{item:i,category:e,color:t,kind:"mark",p:i.position}:null}function X_({scene:i,selected:e,onSelect:t,hiddenCats:n,hiddenLayers:s}){let r=(0,tt.useRef)(null),o=(0,tt.useRef)([]),a=(0,tt.useRef)([]),c=(0,tt.useRef)({s:1,tx:0,ty:0}),l=(0,tt.useRef)(null);return(0,tt.useEffect)(()=>{let u=r.current;if(!u)return;let d=document.createElement("canvas");d.style.width="100%",d.style.height="100%",d.style.display="block",d.style.background="#0b1220",d.style.cursor="crosshair",d.style.touchAction="none",u.appendChild(d);let h=d.getContext("2d"),m=n||{},_=s||{},S=[],p=[],f={};for(let F of["racks","aisles","zones","agvs"])for(let W of i[F]||[])W.handle!=null&&(f[W.handle]={item:W,category:F});let C=0;for(let F of i.entities||[]){if(_[F.layer])continue;let W=F.handle!=null?f[F.handle]:null;if(W&&m[W.category])continue;let J=W?W.item:Object.assign({id:"ent-"+ ++C},F),oe=W?W.category:null,re=fs(Si(i,F.layer)),le=W_(J,oe,re);le&&S.push(le)}let R=0;for(let F of i.entities||[])(F.type==="TEXT"||F.type==="MTEXT")&&!_[F.layer]&&F.text&&(R+=1,p.push({item:Object.assign({id:"text-"+R},F),category:null,p:F.position||{x:0,y:0},text:F.text,color:fs(Si(i,F.layer))}));o.current=S,a.current=p;let y=c.current,E=window.devicePixelRatio||1,v=()=>{let F=1/0,W=1/0,J=-1/0,oe=-1/0,re=Y=>{Y&&(F=Math.min(F,Y.x),W=Math.min(W,Y.y),J=Math.max(J,Y.x),oe=Math.max(oe,Y.y))};for(let Y of S)Y.kind==="poly"?Y.pts.forEach(re):Y.kind==="circle"||Y.kind==="arc"?(re({x:Y.c.x-Y.r,y:Y.c.y-Y.r}),re({x:Y.c.x+Y.r,y:Y.c.y+Y.r})):re(Y.p);for(let Y of p)re(Y.p);F===1/0&&(F=-20,W=-20,J=20,oe=20);let le=d.clientWidth||600,Fe=d.clientHeight||360,Ne=36,q=Math.min((le-Ne*2)/Math.max(J-F,1),(Fe-Ne*2)/Math.max(oe-W,1));y.s=q>0?q:1,y.tx=le/2-(F+J)/2*y.s,y.ty=Fe/2+(W+oe)/2*y.s},M=()=>{let F=d.clientWidth||600,W=d.clientHeight||360,J=y.s,oe=ie=>ie*J+y.tx,re=ie=>y.ty-ie*J;h.setTransform(E,0,0,E,0,0),h.clearRect(0,0,F,W);let le=10;for(;le*J<26;)le*=5;for(;le*J>130;)le/=5;h.lineWidth=1,h.strokeStyle="rgba(148,163,184,0.08)";let Fe=Math.floor((0-y.tx)/J/le)*le,Ne=Math.ceil((F-y.tx)/J/le)*le,q=Math.floor((y.ty-W)/J/le)*le,Y=Math.ceil(y.ty/J/le)*le;h.beginPath();for(let ie=Fe;ie<=Ne;ie+=le)h.moveTo(oe(ie),0),h.lineTo(oe(ie),W);for(let ie=q;ie<=Y;ie+=le)h.moveTo(0,re(ie)),h.lineTo(F,re(ie));h.stroke(),h.strokeStyle="rgba(248,113,113,0.45)",h.beginPath(),h.moveTo(0,re(0)),h.lineTo(F,re(0)),h.stroke(),h.strokeStyle="rgba(52,211,153,0.45)",h.beginPath(),h.moveTo(oe(0),0),h.lineTo(oe(0),W),h.stroke();for(let ie of S){let Re=e&&ie.item&&(e.has(ie.item.id)||ie.item.handle!=null&&e.has(String(ie.item.handle)));if(h.strokeStyle=Re?"#facc15":ie.color,h.fillStyle=h.strokeStyle,h.lineWidth=Re?2.6:1.4,Re?(h.shadowColor="rgba(250,204,21,0.8)",h.shadowBlur=8):h.shadowBlur=0,ie.kind==="poly")h.beginPath(),ie.pts.forEach((ce,Ue)=>{Ue===0?h.moveTo(oe(ce.x),re(ce.y)):h.lineTo(oe(ce.x),re(ce.y))}),h.stroke();else if(ie.kind==="circle")h.beginPath(),h.arc(oe(ie.c.x),re(ie.c.y),Math.max(ie.r*J,.5),0,Math.PI*2),h.stroke();else if(ie.kind==="arc")h.beginPath(),h.arc(oe(ie.c.x),re(ie.c.y),Math.max(ie.r*J,.5),-ie.a1,-ie.a0,!1),h.stroke();else if(ie.kind==="mark"){let ce=oe(ie.p.x),Ue=re(ie.p.y),rt=5;h.beginPath(),h.moveTo(ce-rt,Ue),h.lineTo(ce+rt,Ue),h.moveTo(ce,Ue-rt),h.lineTo(ce,Ue+rt),h.stroke(),h.beginPath(),h.arc(ce,Ue,2.2,0,Math.PI*2),h.stroke()}}h.shadowBlur=0,h.font="12px ui-monospace, Consolas, monospace";for(let ie of p)h.fillStyle=e&&e.has(ie.item.id)?"#facc15":ie.color,h.fillText(String(ie.text).slice(0,48),oe(ie.p.x),re(ie.p.y))},x=()=>{let F=d.clientWidth||600,W=d.clientHeight||360;d.width=Math.max(F*E,1),d.height=Math.max(W*E,1),l.current!==i&&(v(),l.current=i),M()},w=new ResizeObserver(x);w.observe(u),x();let A=(F,W,J,oe)=>{let re=mx(J.x),le=my(J.y),Fe=mx(oe.x),Ne=my(oe.y),q=Fe-re,Y=Ne-le,ie=q*q+Y*Y,Re=ie===0?0:Math.max(0,Math.min(1,((F-re)*q+(W-le)*Y)/ie));return Math.hypot(F-(re+Re*q),W-(le+Re*Y))},I=(F,W)=>{let J=y.s,oe=6;for(let re=p.length-1;re>=0;re--){let le=p[re];if(Math.abs(mx(le.p.x)-F)<44&&Math.abs(my(le.p.y)-W)<9)return{item:le.item,category:null}}for(let re=S.length-1;re>=0;re--){let le=S[re],Fe=!1;if(le.kind==="poly"){for(let Ne=0;Ne+1<le.pts.length;Ne++)if(A(F,W,le.pts[Ne],le.pts[Ne+1])<oe){Fe=!0;break}}else if(le.kind==="circle"){let Ne=Math.hypot(F-mx(le.c.x),W-my(le.c.y));Fe=Math.abs(Ne-le.r*J)<oe||Ne<le.r*J}else if(le.kind==="arc"){let Ne=F-mx(le.c.x),q=W-my(le.c.y),Y=Math.hypot(Ne,q),ie=Math.atan2(-q,Ne);ie<0&&(ie+=Math.PI*2);let Re=le.a0%(Math.PI*2);Re<0&&(Re+=Math.PI*2);let ce=le.a1%(Math.PI*2);ce<0&&(ce+=Math.PI*2);let Ue=ce-Re;Ue<=0&&(Ue+=Math.PI*2);let rt=ie-Re;rt<0&&(rt+=Math.PI*2),Fe=Math.abs(Y-le.r*J)<oe&&rt<=Ue}else le.kind==="mark"&&(Fe=Math.hypot(F-mx(le.p.x),W-my(le.p.y))<oe+4);if(Fe)return{item:le.item,category:le.category}}return null},B=null,G=!1,D=F=>{F.preventDefault();let W=d.getBoundingClientRect(),J=F.clientX-W.left,oe=F.clientY-W.top,re=F.deltaY>0?1/1.12:1.12,le=Math.max(1e-4,y.s*re);y.tx=J-(J-y.tx)*(le/y.s),y.ty=oe-(oe-y.ty)*(le/y.s),y.s=le,M()},X=F=>{B={x:F.clientX,y:F.clientY,tx:y.tx,ty:y.ty},G=!1},$=F=>{if(!B)return;let W=F.clientX-B.x,J=F.clientY-B.y;(Math.abs(W)>2||Math.abs(J)>2)&&(G=!0),y.tx=B.tx+W,y.ty=B.ty+J,M()},j=()=>{B=null},ne=F=>{if(G)return;let W=d.getBoundingClientRect();t(I(F.clientX-W.left,F.clientY-W.top))};return d.addEventListener("wheel",D,{passive:!1}),d.addEventListener("mousedown",X),d.addEventListener("mousemove",$),d.addEventListener("mouseup",j),d.addEventListener("mouseleave",j),d.addEventListener("click",ne),()=>{w.disconnect(),d.removeEventListener("wheel",D),d.removeEventListener("mousedown",X),d.removeEventListener("mousemove",$),d.removeEventListener("mouseup",j),d.removeEventListener("mouseleave",j),d.removeEventListener("click",ne),d.parentNode===u&&u.removeChild(d)}},[i,n,s,e]),(0,k.jsx)("div",{ref:r,style:{flex:1,minHeight:320,borderRadius:8,overflow:"hidden",lineHeight:0}})}function Y_(){let[i,e]=(0,tt.useState)(null),t=(0,tt.useRef)(null),n=(0,tt.useRef)(null),[s,r]=(0,tt.useState)(null),[o,a]=(0,tt.useState)(!1),[c,l]=(0,tt.useState)(null),[u,d]=(0,tt.useState)(!1),[h,m]=(0,tt.useState)({}),[_,S]=(0,tt.useState)(null),[p,f]=(0,tt.useState)(!1);(0,tt.useEffect)(()=>{F_()},[]);let C=A=>m(I=>Object.assign({},I,{[A]:!I[A]})),R=A=>{if(!A){l(null);return}let I=A.device||(A.item&&A.item.handle!=null?zu(s,A.item.handle):null);l({item:A.item||null,category:A.category||null,device:I})},y=A=>l({item:null,category:null,device:A}),E=Vu(c),v=A=>{A&&(t.current=A,r(null),l(null),m({}),S(null),e({name:A.name,size:A.size,status:"ready",error:null}))},M=async()=>{let A=t.current;if(!(!A||o)){a(!0),e(I=>Object.assign({},I,{status:"parsing",error:null}));try{let I=await N_(A,B=>e(G=>Object.assign({},G,{phase:B})));r(I.scene),S(I.download||null),e(B=>Object.assign({},B,{status:"done"}))}catch(I){e(B=>Object.assign({},B,{status:"error",error:String(I&&I.message||I)}))}finally{a(!1)}}},x=u?"drag":o?"parsing":i?i.status==="done"?"done":i.status==="error"?"error":"ready":"idle",w=i?i.status==="ready"?"\u5F85\u89E3\u6790":i.status==="parsing"?i.phase||"\u89E3\u6790\u4E2D\u2026":i.status==="done"?"\u89E3\u6790\u5B8C\u6210":"\u89E3\u6790\u5931\u8D25":"\u5C1A\u672A\u9009\u62E9\u6587\u4EF6";return(0,k.jsxs)("div",{style:ot.wrap,children:[(0,k.jsxs)("div",{style:ot.colLeft,children:[(0,k.jsx)("h3",{style:ot.title,children:"CAD \u6587\u4EF6\u5BFC\u5165\u533A"}),(0,k.jsxs)("div",{className:"cad-im-portal","data-state":x,onClick:()=>{n.current&&n.current.click()},onDragEnter:A=>{A.preventDefault(),d(!0)},onDragOver:A=>A.preventDefault(),onDragLeave:A=>{A.preventDefault(),d(!1)},onDrop:A=>{A.preventDefault(),d(!1),v(A.dataTransfer&&A.dataTransfer.files&&A.dataTransfer.files[0])},children:[(0,k.jsx)("div",{className:"cad-im-grid"}),(0,k.jsx)("span",{className:"cad-im-corner tl"}),(0,k.jsx)("span",{className:"cad-im-corner tr"}),(0,k.jsx)("span",{className:"cad-im-corner bl"}),(0,k.jsx)("span",{className:"cad-im-corner br"}),(0,k.jsx)("div",{className:"cad-im-scan"}),(0,k.jsx)("span",{className:"cad-im-cross",style:{top:18,left:30,animationDelay:"0.2s"}}),(0,k.jsx)("span",{className:"cad-im-cross",style:{top:26,right:36,animationDelay:"0.9s"}}),(0,k.jsx)("span",{className:"cad-im-cross",style:{bottom:22,left:44,animationDelay:"1.6s"}}),(0,k.jsxs)("div",{className:"cad-im-stage",children:[(0,k.jsxs)("svg",{className:"cad-im-icon",viewBox:"0 0 64 64","aria-hidden":"true",children:[(0,k.jsx)("path",{d:"M14 6h26l10 10v42H14z",fill:"rgba(30,58,138,.55)",stroke:"#38bdf8",strokeWidth:"2",strokeLinejoin:"round"}),(0,k.jsx)("path",{d:"M40 6v10h10",fill:"none",stroke:"#38bdf8",strokeWidth:"2",strokeLinejoin:"round"}),(0,k.jsx)("circle",{cx:"31",cy:"36",r:"8.5",fill:"none",stroke:"#7dd3fc",strokeWidth:"2"}),(0,k.jsx)("path",{d:"M31 22.5v6M31 43.5v6M17.5 36h6M38.5 36h6",stroke:"#7dd3fc",strokeWidth:"2",strokeLinecap:"round"})]}),i&&i.status==="done"?(0,k.jsxs)("svg",{className:"cad-im-check",viewBox:"0 0 48 48",children:[(0,k.jsx)("circle",{cx:"24",cy:"24",r:"21"}),(0,k.jsx)("path",{d:"M13 25l7.5 7.5L35 16"})]}):null]}),(0,k.jsx)("div",{className:"cad-im-title",children:u?"\u677E\u624B\uFF0C\u5F00\u59CB\u89E3\u6790\u56FE\u7EB8":"\u62D6\u62FD CAD \u56FE\u7EB8\u5230\u6B64\u5904"}),(0,k.jsx)("div",{className:"cad-im-sub",children:u?"\u652F\u6301 .dwg / .dxf / .step":"\u6216\u70B9\u51FB\u9009\u62E9\u6587\u4EF6 \xB7 \u89E3\u6790\u540E\u5B9E\u4F53\u53E0\u52A0\u5230\u53F3\u4FA7 3D \u573A\u666F"}),i?(0,k.jsxs)("div",{className:"cad-im-chip",children:[i.name," \xB7 ",(i.size/1024).toFixed(1)," KB"]}):null,(0,k.jsx)("input",{ref:n,type:"file",accept:".dwg,.dxf,.step,.stp",style:{display:"none"},onChange:A=>{v(A.target.files&&A.target.files[0]),A.target.value=""}})]}),i?(0,k.jsxs)("div",{style:ot.info,children:[(0,k.jsxs)("div",{children:[(0,k.jsx)("span",{style:ot.label,children:"\u6587\u4EF6"}),i.name]}),(0,k.jsxs)("div",{children:[(0,k.jsx)("span",{style:ot.label,children:"\u5927\u5C0F"}),(i.size/1024).toFixed(1)," KB"]}),(0,k.jsxs)("div",{children:[(0,k.jsx)("span",{style:ot.label,children:"\u72B6\u6001"}),w]}),i.error?(0,k.jsx)("div",{style:{color:"#f87171"},children:i.error}):null]}):null,(0,k.jsxs)("div",{style:{display:"flex",gap:8},children:[(0,k.jsx)("button",{type:"button",className:"cad-im-btn","data-busy":o?"true":"false",disabled:!i||o,onClick:M,children:o?"\u89E3\u6790\u4E2D\u2026":"\u89E3\u6790"}),_?(0,k.jsx)("button",{type:"button",className:"cad-im-btn cad-im-dl",onClick:()=>{let A=document.createElement("a");A.href=_.url,A.download=_.name,document.body.appendChild(A),A.click(),setTimeout(()=>A.remove(),2e3)},children:"\u2B07 \u4E0B\u8F7D DXF"}):null]}),s?(0,k.jsx)(k_,{scene:s,hiddenLayers:h,onToggleLayer:C}):null,s?(0,k.jsx)(z_,{scene:s,selection:c,onSelect:y}):null,s?(0,k.jsx)(V_,{scene:s}):null,s?(0,k.jsx)(G_,{scene:s}):null]}),(0,k.jsxs)("div",{style:ot.col,children:[(0,k.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:8},children:[(0,k.jsx)("h3",{style:Object.assign({},ot.title,{flex:1}),children:p?"CAD \u56FE\u7EB8 \xB7 2D \u4FEF\u89C6":"Three.js 3D \u573A\u666F\u663E\u793A\u533A"}),(0,k.jsxs)("div",{className:"cad-v-toggle",children:[(0,k.jsx)("button",{type:"button",className:"cad-v-btn","data-on":p?"false":"true",onClick:()=>f(!1),children:"3D \u573A\u666F"}),(0,k.jsx)("button",{type:"button",className:"cad-v-btn","data-on":p?"true":"false",onClick:()=>f(!0),children:"CAD \u56FE\u7EB8"})]})]}),(0,k.jsxs)("div",{style:{position:"relative",flex:1,minHeight:0,display:"flex"},children:[p?(0,k.jsx)(X_,{scene:s||mc,selected:E,onSelect:R,hiddenLayers:h}):(0,k.jsx)(ku,{scene:s||mc,selected:E,onSelect:R,hiddenLayers:h}),s?null:(0,k.jsx)("div",{style:{position:"absolute",inset:0,display:"flex",alignItems:"flex-end",justifyContent:"center",paddingBottom:12,pointerEvents:"none",fontSize:12,opacity:.7},children:p?"\u89E3\u6790\u540E\u5728\u6B64\u67E5\u770B CAD \u56FE\u7EB8\uFF08\u6EDA\u8F6E\u7F29\u653E\u3001\u62D6\u62FD\u5E73\u79FB\uFF0C\u70B9\u51FB\u56FE\u5143\u67E5\u770B\u8BE6\u60C5\uFF09":"\u89E3\u6790\u540E\u5B9E\u4F53\u5C06\u53E0\u52A0\u5230\u573A\u666F\u4E2D\uFF08\u5DE6\u952E\u65CB\u8F6C\u3001\u6EDA\u8F6E\u7F29\u653E\u3001\u53F3\u952E\u5E73\u79FB\uFF0C\u70B9\u51FB\u5B9E\u4F53\u67E5\u770B\u8BE6\u60C5\uFF09"})]}),(0,k.jsx)(Hu,{scene:s||mc,selection:c})]})]})}function q_(i){return(0,k.jsx)(Go,{children:(0,k.jsx)(Y_,{...i})})}function Ou(i){let e=i&&i.content||[];for(let t of e)if(t&&t.type==="text"&&typeof t.text=="string")return t.text;return""}function Z_(i){if(!i||i.kind!=="tool-result"||i.isError)return null;for(let e of i.content||[])if(!(!e||e.type!=="text"||typeof e.text!="string"))try{let t=JSON.parse(e.text);if(t&&Array.isArray(t.racks)&&Array.isArray(t.aisles)&&Array.isArray(t.zones))return t}catch{}return null}function J_(i){let e=i&&i.block,t=(0,tt.useMemo)(()=>Z_(e),[e]),[n,s]=(0,tt.useState)(null);return!e||e.kind!=="tool-result"?(0,k.jsx)("div",{style:ot.info,children:"\u6B63\u5728\u89E3\u6790 CAD \u56FE\u7EB8\u2026"}):e.isError?(0,k.jsxs)("div",{style:ot.info,children:["\u89E3\u6790\u5931\u8D25\uFF1A",Ou(e)]}):t?(0,k.jsxs)("div",{style:{display:"flex",flexDirection:"column",gap:8,padding:"4px 0"},children:[(0,k.jsx)(O_,{scene:t}),t.meta&&t.meta.summary&&(t.entities||[]).length===0?(0,k.jsxs)("div",{style:ot.info,children:[(0,k.jsxs)("div",{children:[(0,k.jsx)("b",{children:"\u6458\u8981\u6A21\u5F0F"}),"\uFF08detail: 'full' \u8FD4\u56DE\u5168\u91CF\u5B9E\u4F53\uFF09"]}),Object.entries(t.meta.summary.byType||{}).map(r=>(0,k.jsxs)("div",{children:[(0,k.jsx)("span",{style:ot.label,children:r[0]}),r[1]]},r[0])),(t.layers||[]).slice(0,24).map(r=>(0,k.jsxs)("div",{children:[(0,k.jsx)("span",{style:ot.label,children:r.name}),r.count]},r.name))]}):(0,k.jsx)("div",{style:{height:380,display:"flex"},children:(0,k.jsx)(ku,{scene:t,selected:Vu(n),onSelect:r=>s(r?{item:r.item||null,category:r.category||null,device:r.device||(r.item&&r.item.handle!=null?zu(t,r.item.handle):null)}:null)})}),(0,k.jsx)(Hu,{scene:t,selection:n})]}):(0,k.jsx)("pre",{style:ot.pre,children:Ou(e)})}function K_(i){return(0,k.jsx)(Go,{children:(0,k.jsx)(J_,{...i})})}function $_(i){let e=i&&typeof i.size=="number"?i.size:18;return(0,k.jsx)("span",{style:{fontSize:e,lineHeight:1},children:"\u{1F4D0}"})}function j_(i){i.slots.inject("sidebar.panellist",()=>i.slots.register({name:"sidebar.panellist",id:"cad-scene-builder",label:"3d\u89E3\u6790",order:100},$_)),i.slots.inject("main",()=>i.slots.register({name:"main",key:"cad-scene-builder"},q_)),i.slots.inject("tool.call.toolview",()=>i.slots.register({name:"tool.call.toolview",key:"parse_cad_to_scene"},K_))}
