    ...
    output: {
      schema: {
        ...
        properties: {
          ...
          devices: sceneItems('Individual device units clustered from touching/nearby geometry: id, layer (original name), name (nearest text), center, size, entityCount, member handles.'),
